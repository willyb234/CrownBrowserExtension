        ...
        if (!document.getElementsByClassName('quizQuestion')[0]) {
            ...
            if (document.getElementsByClassName('quizThrottle')[0] && quizName != "Zafaria")
                ...
                if (document.getElementsByClassName('rewardText') && document.getElementsByClassName('rewardText')[0].innerText[0] == 'Y') {
					...
					//opens captcha
					sleep(2000).then(() => {
					var iframe = document.getElementById('jPopFrame_content');
					var elmnt = iframe.contentWindow.document.getElementById("submit");
					elmnt.click();
					});
                    ...
                    addCrowns();
					window.location = ('https://wizard101.com/auth/logout/game?redirectUrl=https%3A%2F%2Fwww.wizard101.com%2Fgame');
				}
            }
        }
        else {
